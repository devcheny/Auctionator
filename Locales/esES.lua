...
AtrL["Share scan data between factions"] = "Compartir datos de escaneo entre facciones"
...
AtrL["Auction avg"] = "Media en subasta"
...
AtrL["If this option is checked, scan data will be shared between Horde and Alliance characters on the same realm. Requires /reload to take effect."] = "Si esta opción está activada, los datos de escaneo se compartirán entre personajes de la Horda y la Alianza del mismo reino. Requiere /reload para aplicarse."
...
-- Earnings (Ganancias)
AtrL["No active auctions"] = "Sin subastas activas"
AtrL["Active Auctions: %d"] = "Subastas activas: %d"
