...
function Atr_AuctionFrameTab_OnClick (self, index, down)
	...
	elseif (Atr_IsAuctionatorTab(index)) then
		...
		if (index == Atr_FindTabIndex(SELL_TAB))	then AuctionatorTitle:SetText ("Auctionator Cheny - "..ZT("Sell"));			end;
		if (index == Atr_FindTabIndex(BUY_TAB))		then AuctionatorTitle:SetText ("Auctionator Cheny - "..ZT("Buy"));			end;
		if (index == Atr_FindTabIndex(MORE_TAB))	then AuctionatorTitle:SetText ("Auctionator Cheny - "..ZT("More").."...");	end;
